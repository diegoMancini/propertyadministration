		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<form action="addContractToFunctionalUnit" method="POST" class="form-material m-t-20">
                                ...
                                <input type="hidden" name="propertyName" value="<%=request.getAttribute("propertyName")%>">
