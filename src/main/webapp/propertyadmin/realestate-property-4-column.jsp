            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Property 4-Column</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Property 4-Column</li>
                            </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <img class="card-img-top" src="../assets/images/property/prop1.jpeg" alt="Card image cap">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <img class="card-img-top" src="../assets/images/property/prop2.jpeg" alt="Card image cap">
                            <div class="card-img-overlay">
                                <span class="badge badge-danger badge-pill">For Rent</span>
                            </div>
                            <div class="card-body bg-light">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <img class="card-img-top" src="../assets/images/property/prop6.jpg" alt="Card image cap">
                            <div class="card-img-overlay">
                                <span class="badge badge-danger badge-pill">For Rent</span>
                            </div>
                            <div class="card-body bg-light">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <img class="card-img-top" src="../assets/images/property/prop4.jpeg" alt="Card image cap">
                            <div class="card-img-overlay">
                                <span class="badge badge-danger badge-pill">For Rent</span>
                            </div>
                            <div class="card-body bg-light">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-top">
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div>
                                        <h5 class="card-title m-b-0">Jon Doe</h5>
                                        <small class="text-muted">5 Property</small>
                                    </div>
                                </div>
                            </div>
                        </div>
